...
function pressureVerification() {
  ...
  //   let geometry = ParticlesArr[point.currentIndex].line.geometry;

  //   scene.remove(ParticlesArr[point.currentIndex].line);

  //   geometry.colors[point.currentSubIndex] = new THREE.Color(
  //     tam / 2,
  //     2 / tam,
  //     0
  //   );
  ...
  //   scene.add(line);
  //   ParticlesArr[point.currentIndex].line = line;
